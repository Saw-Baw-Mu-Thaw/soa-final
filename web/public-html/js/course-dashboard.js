...
async function showCourseDetail() {
    ...
    assignments.forEach(assignment => {
        ...
        if (currentRole === 'teacher') {
            assignmentMenuHTML = `
                <div class="menu-container">
                    ...
                    <div id="dropdown-assignment-${assignment['homeworkId']}" class="dropdown-content">
                        <a href="#" onclick="editAssignment(${assignment['homeworkId']}, ${assignment['courseId']})">Edit</a>
                        <a href="#" onclick="viewSubmissions(${assignment['homeworkId']}, ${assignment['courseId']})">View Submissions</a>
            ...
            assignmentMenuHTML = `<button class="btn-primary" style="padding:5px 10px; font-size:0.8rem" onclick="viewAssignment(${assignment['homeworkId']}, ${assignment['courseId']})">View Details</button>`;
        }
