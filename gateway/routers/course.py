...
@router.get('/course/teacher', dependencies=[Depends(is_teacher)])
...
@router.post('/course/create', dependencies=[Depends(is_head)])
...
@router.put('/course/{course_id}', dependencies=[Depends(is_head)])
...
@router.get('/course/head', dependencies=[Depends(is_head)])
